...
import brume.core;
import brume.render.window, brume.render.drawable, brume.render.texture;
...
final class Sprite : Drawable {
    ...
    /*void drawRotated(const Vec2f position) {
        ...
        dist.rotate(angle);
        texture.draw(transformRenderSpace(position - dist), finalSize, clip, angle, flip, anchor, blend, color, alpha);
    }
