module brume.script.primitive;

import grimoire;

import brume.core, brume.render;

package(brume.script) void loadBrumeLibPrimitive(GrLibrary library) {
...
private void _rectangle3(GrCall call) {
        drawFilledRect(Vec2f(call.getFloat(0), call.getFloat(1)),
                Vec2f(call.getFloat(2), call.getFloat(3)), Color(call.getObject(4)), call.getFloat(
                        5));
}
